...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A full-stack Library Management System that enables users to browse, borrow, and return books with real-time inventory updates and secure role-based access.',
    ...
    },
    {
      ...
      description: 'A dynamic MERN stack platform where users can discover, join, and create local hobby-based groups with real-time interactions and secure authentication.',
